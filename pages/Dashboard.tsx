// --- START OF FILE src/pages/Dashboard.tsx (النسخة النهائية الكاملة والمصححة) ---

import React, { useState } from 'react'; // <-- تم تصحيح الخطأ هنا
      ...
      <div className="z-10">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link to="/transport-costs" className="flex items-center justify-center text-center bg-indigo-600 text-white px-6 py-4 rounded-lg hover:bg-indigo-700 transition-colors duration-300 shadow-md text-lg font-semibold">
              <Truck size={24} className="ml-3" />
              حساب تكلفة النقل
            </Link>
          </div>
        </div>
